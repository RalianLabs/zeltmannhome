  ...
  return (
    <section id="experiencia" className="py-16 md:py-20">
      <div className="max-w-6xl mx-auto px-4">
        <SectionHeading
          title="Vive Nerja"
          subtitle="Descubre todo lo que esta joya de la Costa del Sol tiene para ofrecerte"
        />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {experiences.map((exp) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-sand/20 text-sand-dark mb-4">
                {icons[exp.icon]}
              </div>
