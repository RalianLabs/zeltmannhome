            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-cream rounded-2xl p-8">
                ...
                <p className="text-muted text-sm mb-6">
                  Mejor precio reservando directamente. Sin comisiones.
                </p>

                <a
                  href="#reserva"
                  className="flex items-center justify-center gap-2 w-full py-3.5 rounded-full bg-sand text-navy font-semibold text-sm hover:brightness-110 transition-all duration-300 mb-3"
                >
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3.5 rounded-full border-2 border-navy/15 text-navy font-semibold text-sm hover:bg-whatsapp hover:text-white hover:border-whatsapp transition-all duration-300"
                >
              ...
              <div className="bg-sand/10 rounded-xl px-5 py-4 text-center">
                <p className="text-xs text-navy/70 leading-relaxed">
                  <strong className="text-gold">Mejor precio directo</strong> — ahorra frente a
                  Airbnb y Booking reservando aquí
                </p>
              </div>
